...
echo 'scheduler='$(getprop scheduler) >> /vendor/overlay/local.prop
...
echo 'tcpcong='$(getprop tcpcong) >> /vendor/overlay/local.prop
...
echo 'minkhz='$(getprop minkhz) >> /vendor/overlay/local.prop
...
echo 'minkhz2='$(getprop minkhz2) >> /vendor/overlay/local.prop
...
echo 'gov='$(getprop gov) >> /vendor/overlay/local.prop
...
echo 'gov2='$(getprop gov2) >> /vendor/overlay/local.prop
...
echo 'maxkhz='$(getprop maxkhz) >> /vendor/overlay/local.prop
...
echo 'maxkhz2='$(getprop maxkhz2) >> /vendor/overlay/local.prop
